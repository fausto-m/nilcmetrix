...
from text_metrics.metrics import guten
from text_metrics.tools import spacy_tagger, syllable_separator
...
class ConcretudeMean(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ConcretudeMean.value_for_text(self, t)
...
class ConcretudeStd(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ConcretudeStd.value_for_text(self, t)
...
class Concretude_1_25(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Concretude_1_25.value_for_text(self, t)
...
class Concretude_25_4(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Concretude_25_4.value_for_text(self, t)
...
class Concretude_4_55(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Concretude_4_55.value_for_text(self, t)
...
class Concretude_55_7(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Concretude_55_7.value_for_text(self, t)
...
class ImageabilidadeMean(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ImageabilidadeMean.value_for_text(self, t)
...
class ImageabilidadeStd(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ImageabilidadeStd.value_for_text(self, t)
...
class Imageabilidade_1_25(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Imageabilidade_1_25.value_for_text(self, t)
...
class Imageabilidade_25_4(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Imageabilidade_25_4.value_for_text(self, t)
...
class Imageabilidade_4_55(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Imageabilidade_4_55.value_for_text(self, t)
...
class Imageabilidade_55_7(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Imageabilidade_55_7.value_for_text(self, t)
...
class FamiliaridadeMean(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.FamiliaridadeMean.value_for_text(self, t)
...
class FamiliaridadeStd(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.FamiliaridadeStd.value_for_text(self, t)
...
class Familiaridade_1_25(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Familiaridade_1_25.value_for_text(self, t)
...
class Familiaridade_25_4(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Familiaridade_25_4.value_for_text(self, t)
...
class Familiaridade_4_55(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Familiaridade_4_55.value_for_text(self, t)
...
class Familiaridade_55_7(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Familiaridade_55_7.value_for_text(self, t)
...
class IdadeAquisicaoMean(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.IdadeAquisicaoMean.value_for_text(self, t)
...
class IdadeAquisicaoStd(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.IdadeAquisicaoStd.value_for_text(self, t)
...
class IdadeAquisicao_1_25(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.IdadeAquisicao_1_25.value_for_text(self, t)
...
class IdadeAquisicao_25_4(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.IdadeAquisicao_25_4.value_for_text(self, t)
...
**Status**: correto
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.IdadeAquisicao_4_55.value_for_text(self, t)
...
class IdadeAquisicao_55_7(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.IdadeAquisicao_55_7.value_for_text(self, t)
...
class PrepositionDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.PrepositionDiversity.value_for_text(self, t)
...
class HardConjunctions(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.HardConjunctions.value_for_text(self, t)
...
class EasyConjunctions(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.EasyConjunctions.value_for_text(self, t)
...
class IndefinitePronounsDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.IndefinitePronounsDiversity.value_for_text(self, t)
...
class IndefinitePronouns(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.IndefinitePronouns.value_for_text(self, t)
...
class AbstractNouns(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.AbstractNouns.value_for_text(self, t)
...
class TalkToReader(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.TalkToReader.value_for_text(self, t)
...
class NotSVO(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        text = spacy_tagger.text(t)
        verbs = [ w for w in text if w.pos_ == "VERB"]
        clauses = []
        for verb in verbs:
            children = list(verb.children)
            verb_subjects = [ w for w in children if w.dep_ == "nsubj"]
            verb_objs = [ w for w in children if w.dep_ == "obj"]
            subject_i = None
            obj_i = None

            if (len(verb_subjects) > 0):
                subject_i = verb_subjects[0].i
            if (len(verb_objs) > 0):
                obj_i = verb_objs[0].i

            if (len(clauses) > 0 and next(( x for x, clause in enumerate(clauses) if clause["verb_i"] == ( verb.i - 1 )), -1) != -1): #To account for composite verbs
                sentence = [ x for x in clauses if x["verb_i"] == ( verb.i - 1 ) ]
                if (len(sentence) > 0 and ( subject_i != None or obj_i != None )):
                    if (subject_i != None):
                        sentence[0]["subject_i"] = subject_i
                    if (obj_i != None):
                        sentence[0]["obj_i"] = obj_i
            else:
                clauses.append(
                    {
                        "subject_i": subject_i,
        ...
        for clause in clauses:
            if (clause["subject_i"] != None and clause["obj_i"] != None):
                if (clause["verb_i"] > clause["subject_i"] and clause["verb_i"] < clause["obj_i"]):
                    svo_count += 1
        nverbs = len(spacy_tagger.verbs(t))
        try:
            return (nverbs-svo_count) / nverbs
        except ZeroDivisionError:
            return 0
...
class TopicalizedClausesRatio(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        count = 0
        verbs = spacy_tagger.verbs(t)
        for verb in verbs:
            children = list(verb.children)
            advl_child_before = [ w for w in children if w.pos_ == "ADV" and w.i < verb.i]
            count += len(advl_child_before)
        nverbs = len(verbs)
        try:
            return count / nverbs
        except ZeroDivisionError:
...
class PostponedSubject(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        text = spacy_tagger.text(t)
        subjects = [ w for w in text if "nsubj" in w.dep_ ]
        postponed = 0
        for subject in subjects:
            if subject.i > subject.head.i:
                postponed =+ 1
        
        try:
            return postponed / len(subjects)
        except ZeroDivisionError:
            return 0
...
class ObliquePronounsRatio(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        ...
        return guten.ObliquePronounsRatio.value_for_text(self, t)
...
class TemporalAdjunctRatio(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        text = spacy_tagger.text(t)
        adjuncts = [ w.i for w in text if w.dep_ == "advmod" ]
        temporal_expressions = rp.temporal_expressions(t)
        temporal_string_start_idx = [ w[1] for w in temporal_expressions ]
        temporals = [ w.i for w in text if w.idx in temporal_string_start_idx ]
        for t_i in temporals:
            if len([ i for i in adjuncts if i == t_i ]) == 0:
                adjuncts.insert(t_i, 1) #Add to list of adjuncts if temporal is not part of adjuncts list
        try:
...
class RelativePronouns(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        text = spacy_tagger.text(t)
        relativos = spacy_tagger.word_by_feat_value(t, "PronType", "Rel")
        pronouns = [w for w in text if w.morph.to_dict().get("PronType") != None]
        try:
...
class RelativePronounsDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        text = spacy_tagger.text(t)
        relativos = [w.lemma_ for w in text if w.morph.to_dict().get("PronType") == "Rel"]
        unique = set(relativos)
        try:
            return len(unique) / len(relativos)
        except ZeroDivisionError:
            return 0
...
class ShortSentencesRate(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        ...
        sentences = spacy_tagger.tagged_words_in_sents(t) #changed original logic as it was tagging quotes as nouns, increasing the number of words
...
class SentenceLengthMin(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return min(spacy_tagger.sentence_lengths(t))
...
class SentenceLengthMax(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return max(spacy_tagger.sentence_lengths(t))
...
class SentenceLengthStandardDeviation(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        lengths = spacy_tagger.sentence_lengths(t)
...
class ContentWordsAmbiguity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ContentWordsAmbiguity.value_for_text(self, t)
...
class Subtitles(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.Subtitles.value_for_text(self, t)
...
class FunctionWordDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.FunctionWordDiversity.value_for_text(self, t)
...
class ContentWordsMin(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ContentWordsMin.value_for_text(self, t)
...
class ContentWordsMax(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ContentWordsMax.value_for_text(self, t)
...
class ContentWordsStandardDeviation(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ContentWordsStandardDeviation.value_for_text(self, t)
...
class ContentWordDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ContentWordDiversity.value_for_text(self, t)
...
class PronounsMin(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.PronounsMin.value_for_text(self, t)
...
class PronounsMax(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.PronounsMax.value_for_text(self, t)
...
class PronounsStandardDeviation(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.PronounsStandardDeviation.value_for_text(self, t)
...
class PronounDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.PronounDiversity.value_for_text(self, t)
...
class AdverbsMin(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.AdverbsMin.value_for_text(self, t)
...
class AdverbsMax(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.AdverbsMax.value_for_text(self, t)
...
class AdverbsStandardDeviation(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.AdverbsStandardDeviation.value_for_text(self, t)
...
class AdverbDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.AdverbDiversity.value_for_text(self, t)
...
class AdjectivesMin(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
       return guten.AdjectivesMin.value_for_text(self, t)
...
class AdjectivesMax(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.AdjectivesMax.value_for_text(self, t)
...
class AdjectivesStandardDeviation(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.AdjectivesStandardDeviation.value_for_text(self, t)
...
class AdjectiveDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.AdjectiveDiversity.value_for_text(self, t)
...
class NounsMin(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.NounsMin.value_for_text(self, t)
...
class NounsMax(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
       return guten.NounsMax.value_for_text(self, t)
...
class NounsStandardDeviation(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.NounsStandardDeviation.value_for_text(self, t)
...
class NounDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.NounDiversity.value_for_text(self, t)
...
class VerbsMin(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.VerbsMin.value_for_text(self, t)
...
class VerbsMax(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.VerbsMax.value_for_text(self, t)
...
class VerbsStandardDeviation(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.VerbsStandardDeviation.value_for_text(self, t)
...
class VerbDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.VerbDiversity.value_for_text(self, t)
...
class DaleChall(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        ...
        text = spacy_tagger.text(t)
        word_lemmas = [ w.lemma_ for w in text if w.pos_ != "PUNCT" and w.pos_ != "SPACE"]
        compound_lemmas = [ w for w in word_lemmas if " " in w ]
        for w in compound_lemmas:
            w_split = w[1].split()
            word_lemmas = word_lemmas + w_split
        word_lemmas = [ w for w in word_lemmas if w not in compound_lemmas ]  #Remove the compound words from the list
        ...
        ret = (0.1579 * unfamiliar_words / 100) + (0.0496 * words_sentence) # Based on documentation, unfamiliar words should be divided by 100
...
class GunningFog(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.GunningFog.value_for_text(self, t)
...
class ContentDensity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.ContentDensity.value_for_text(self, t)
...
class NamedEntitiesRatioText(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        ents = spacy_tagger.ents(t)
        words = spacy_tagger.words(t)
        try:
...
class NamedEntitiesRatioSentence(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        sentences = list(spacy_tagger.sents(t))
        results = []
        sentence_words = spacy_tagger.tagged_words_in_sents(t)
        sentence_ents = spacy_tagger.ents_by_sentence(t)
        for i, w in enumerate(sentence_words):
            try:
                results.append(len(sentence_ents[i]) / len(sentence_words[i]))
            except ZeroDivisionError:
                results.append(0)
        try:
...
class PunctuationRatio(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.PunctuationRatio.value_for_text(self, t)
...
class PunctuationDiversity(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.PunctuationDiversity.value_for_text(self, t)
...
class IndicativePresentMoodRatio(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        tenses = spacy_tagger.count_verb_tenses(t)
...
class MeanNounPhrase(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
       return guten.MeanNounPhrase.value_for_text(self, t)
...
class MaxNounPhrase(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.MaxNounPhrase.value_for_text(self, t)
...
class MinNounPhrase(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.MinNounPhrase.value_for_text(self, t)
...
class StdNounPhrase(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        return guten.StdNounPhrase.value_for_text(self, t)
...
class InfiniteSubordinateClauses(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        infinitive = spacy_tagger.word_by_feat_value(t, "VerbForm", "Inf")
        gerund = spacy_tagger.word_by_feat_value(t, "VerbForm", "Ger")
        participle = spacy_tagger.word_by_feat_value(t, "VerbForm", "Part")
        infinite_subordinate = sum([
            len(infinitive),
            len(gerund),
            len(participle)
        ])
        try:
            return infinite_subordinate / spacy_tagger.num_clauses(t)
        except ZeroDivisionError:
            return 0
...
class SubordinateClauses(base.Metric):
    ...
    def value_for_text(self, t, rp=default_rp):
        text = spacy_tagger.text(t)
        redux_subordinate = [ w for w in text if (
                w.morph.to_dict().get("VerbForm") == "Inf" or
                w.morph.to_dict().get("VerbForm") == "Ger" or
                w.morph.to_dict().get("VerbForm") == "Part"
            )
        ]
        relcl = [ w for w in text if w.dep_ == "acl:relcl" ]
        num_subordinate = sum ( [
                len(redux_subordinate),
                len(relcl)
            ]
        )
        try:
            return num_subordinate / spacy_tagger.num_clauses(t)
        except ZeroDivisionError:
            return 0
        


class SpacyGUTEN(base.Category):
    name = 'GUTEN'
    table_name = 'guten'

    def __init__(self):
        super(SpacyGUTEN, self).__init__()
