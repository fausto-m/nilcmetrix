...
class WordsBeforeMainVerb(base.Metric):
    """
        ...
        **Status**: correto
        ...
        ## Fausto: na implementação com spacy, o resultado é 7 porque fiz as vírgulas serem ignoradas como palavras.
...
class SpacyConstituents(base.Category):
    """"""
    ...
    def __init__(self):
        super(SpacyConstituents, self).__init__()
